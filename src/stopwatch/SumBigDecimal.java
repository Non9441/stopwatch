...
public class SumBigDecimal implements Runnable {
	 ...
	 * 
	 * @param counter
	 *            is how many times you want to sum array of BigDecimal.
	 * @param ARRAY_SIZE
	 *            is a constant of an array size you define.
	 */
	...
	/**
	 * Sum array of BigDecimal and print out information etc. sum value,count
	 * value.
	 */
	public void run() {
